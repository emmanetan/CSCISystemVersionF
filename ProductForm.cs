...
namespace AntdUIDemo
{
    public partial class ProductForm : AntdUI.Window
    {
        ...
        private void InitializeDataGridView()
        {
            ...
            gridViewProductList.Rows.Add("P001", "C2 na green", "Beverage", "2024-01-01", "2026-05-05", 1, 100.00);
            gridViewProductList.Rows.Add("P002", "C2 na re", "Beverage", "2024-01-01", "2026-05-05", 20, 100.00);
